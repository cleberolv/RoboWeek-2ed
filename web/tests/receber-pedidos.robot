...
***Test Cases***
Receber novo pedido
    Dado que "cleberol@gmail.com" é a minha conta de cozinheiro
    E "cleberqa@gmail.com.br" é o email do meu cliente
    E que "Lasanha" está cadastrado no meu dashboard
